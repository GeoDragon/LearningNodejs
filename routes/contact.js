...
router.post('/send',function(req,res,next){
   ...
   var mailOptions = {
       from: 'ABC XYZ <abcxyz@gmail.com>',
       to: 'anything@gmail.com',
       ...
       html: '<p>You got a new submission with the following details</p><ul><li>Name: '+req.body.name+'</li><li>Email: '+req.body.email+'</li>' +
